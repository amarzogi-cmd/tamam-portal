...
export default function FinancialApproval() {
  ...
  // جلب تفاصيل المشروع
  const { data: projectData, isLoading, refetch } = trpc.projects.getById.useQuery(
  ...
  const acceptedQuotation = projectData?.quotations?.find((q: any) => q.status === "accepted");
      ...
      <div className="space-y-6">
        ...
        {selectedRequestId && (
          <>
            ...
            {!acceptedQuotation && projectData?.quotations && projectData.quotations.length > 0 && (
