...
## المرحلة 34: تحسين مرونة اختيار عرض السعر الأنسب

- [x] إظهار جميع عروض الأسعار للاختيار الحر (ليس الأقل فقط)
- [x] إضافة حقل "المبلغ المعتمد" قابل للتعديل عند اعتماد العرض (للتفاوض) مع رسالة تنبيه
- [x] إضافة قسم اعتماد عروض الأسعار في صفحة تفاصيل الطلب (تبويب التقييم المالي)
- [x] ربط عملية الاعتماد بصفحة الطلب مباشرة (أزرار اعتماد/رفض لكل عرض)
- [x] اختبار التعديلات
