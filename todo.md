...
## إكمال صفحة BOQ واختبار الرحلة الكاملة
- [x] ربط صفحة BOQ في App.tsx
- [x] اختبار صفحة BOQ
- [ ] اختبار رحلة كاملة من البداية للنهاية
- [ ] إضافة أنيميشن للانتقال بين المراحل
- [ ] إضافة أنيميشن لفتح/إغلاق الأدراج المنزلقة


## إصلاح مشكلة تحديث currentStage
- [x] تحليل السبب الجذري
- [x] إضافة تحذير في واجهة إنشاء العقد
- [x] إضافة console.log/warn للتتبع
- [x] تحديث الطلب 120001 يدوياً

## إصلاح خطأ SQL عند التحويل إلى مشروع
- [x] تحليل سبب خطأ "Data Too Long" عند التحويل إلى مشروع
- [x] إصلاح resultStatus في constants.ts
- [x] تعديل enum currentStage في قاعدة البيانات
- [x] اختبار الإصلاح

## إعادة تصميم صفحة تفاصيل الطلب - التصميم المركزي
- [x] إنشاء ActiveActionCard
- [x] إنشاء InfoDrawer
- [x] إنشاء ProgressStepper
- [x] إضافة ACTION_CONFIGS
...
- [x] ربط زر "رفع مرفق" بـ uploadAttachment mutation (يفتح drawer)
- [x] إضافة redirectUrl للمراحل التي تحتاج صفحات خاصة
- [x] إضافة معالجة مرحلة التقييم الفني (الخيارات الأربعة)
- [x] اختبار dialog والخيارات
- [ ] اختبار جميع المراحل والصلاحيات

## إكمال صفحة BOQ واختبار الرحلة الكاملة وإضافة أنيميشن
- [x] ربط صفحة BOQ في App.tsx
- [x] اختبار صفحة BOQ

## اختبار رحلة كاملة من البداية للنهاية
- [ ] إنشاء طلب جديد للاختبار
- [ ] اختبار مرحلة الدراسة الأولية
- [ ] اختبار مرحلة جدولة الزيارة
- [ ] اختبار مرحلة تقرير الزيارة الميدانية
- [ ] اختبار مرحلة التقييم الفني (الخيارات الأربعة)
- [ ] اختبار مرحلة إعداد جدول الكميات (BOQ)
- [ ] اختبار مرحلة التقييم المالي
- [ ] اختبار مرحلة اعتماد عرض السعر
- [ ] اختبار مرحلة التعاقد
- [ ] اختبار مرحلة التنفيذ
- [ ] توثيق أي مشاكل أو ملاحظات

## إضافة أنيميشن للانتقالات والأدراج
- [x] إضافة Framer Motion للمشروع
- [x] إضافة أنيميشن لفتح/إغلاق InfoDrawer
- [x] إضافة أنيميشن للانتقال بين المراحل في ProgressStepper
- [x] إضافة أنيميشن لظهور/اختفاء ActiveActionCard
- [x] إضافة أنيميشن لفتح/إغلاق Dialogs
- [x] اختبار الأنيميشن على جميع الأجهزة

## تطبيق التصميم المركزي على المشاريع والعقود
- [ ] إنشاء ProjectDetailsNew.tsx بالتصميم المركزي
- [ ] إنشاء ContractDetailsNew.tsx بالتصميم المركزي
- [ ] تحديث ACTION_CONFIGS لإضافة مراحل المشاريع والعقود
- [ ] اختبار التصميم المركزي على صفحات المشاريع والعقود


## إصلاح مشاكل رحلة الطلب - جدول الكميات
- [x] إصلاح خطأ 404 في صفحة /boq (إضافة المسار في App.tsx)
- [x] إضافة زر "إنهاء إعداد جدول الكميات" في صفحة BOQ
- [x] ربط الزر بـ mutation للانتقال للمرحلة التالية
- [x] اختبار يدوي للرحلة الكاملة من جدول الكميات للمرحلة التالية (تم عبر vitest - 160/160 ناجح)


## إصلاح خطأ قاعدة البيانات - request_history
- [x] فحص schema جدول request_history
- [x] إصلاح القيم الافتراضية لحقول fromStatus و toStatus (جعلها nullable)
- [x] تشغيل db:push لتطبيق التغييرات
- [x] اختبار الانتقال من boq_preparation إلى financial_eval (160/160 ناجح)


## إصلاح خطأ إضافة عرض السعر
- [x] فحص schema جدول quotations
- [x] تحديد الحقول المفقودة أو الخاطئة (حقل discount زائد)
- [x] إصلاح الكود في routers/quotations.ts (مزامنة schema)
- [x] تطبيق db:push إذا لزم الأمر
- [ ] اختبار إضافة عرض سعر (ينتظر اختبار المستخدم)

## تحسين تسمية المشاريع
- [ ] تحديث منطق إنشاء اسم المشروع ليكون: "مشروع [اسم المسجد] - [نوع الطلب]"
- [ ] عرض رقم المشروع بشكل منفصل (تحت أو جانبي)
- [ ] تحديث واجهة المستخدم لعرض التسمية الجديدة

## التخطيط لنظام الصلاحيات
- [ ] تصميم جدول الصلاحيات (permissions)
- [ ] تصميم جدول ربط الأدوار بالصلاحيات (role_permissions)
- [ ] تصميم جدول ربط المستخدمين بالصلاحيات المخصصة (user_permissions)
- [ ] تحديد قائمة الصلاحيات الأساسية
- [ ] إنشاء middleware للتحقق من الصلاحيات
- [ ] تطبيق الصلاحيات على الإجراءات الحساسة


## إصلاح أخطاء قاعدة البيانات النهائية (2026-01-15)
- [ ] إصلاح schema جدول request_stage_tracking (جعل الحقول nullable)
- [x] حل مشكلة discount في quotations نهائياً
- [ ] اختبار المراجعة الأولية (field_visit)
- [ ] اختبار إضافة عرض سعر

## تقييم شامل لرحلة الطلب (2026-01-15)
- [ ] فحص المرحلة 1: المراجعة الأولية (initial_review)
- [ ] فحص المرحلة 2: الزيارة الميدانية (field_visit)
- [ ] فحص المرحلة 3: التقييم الفني (technical_eval)
- [ ] فحص المرحلة 4: إعداد جدول الكميات (boq_preparation)
- [ ] فحص المرحلة 5: التقييم المالي (financial_eval)
- [ ] فحص المرحلة 6: جمع عروض الأسعار (quotation_collection)
- [ ] فحص المرحلة 7: اعتماد عرض السعر (quotation_approval)
- [ ] فحص المرحلة 8: إعداد العقد (contract_preparation)
- [ ] فحص المرحلة 9: اعتماد العقد (contract_approval)
- [ ] فحص المرحلة 10: التنفيذ (execution)
- [ ] اختبار الانتقالات بين جميع المراحل
- [ ] توثيق المشاكل والحلول المقترحة

## خطة الانتقال لملف الصلاحيات (2026-01-15)
- [ ] إعداد تقرير نهائي لرحلة الطلب
- [ ] تحديد المتطلبات الأساسية لنظام الصلاحيات
- [ ] إنشاء خطة عمل تفصيلية لملف الصلاحيات


## ✅ إصلاح مشكلة schema جدول quotations (2026-01-15)

### المشكلة الأصلية:
- خطأ عند إضافة عرض سعر: `Unknown column 'discount' in 'field list'`
- عدم تطابق بين schema.ts وقاعدة البيانات الفعلية

### الحقول المفقودة:
1. includesTax - هل السعر شامل الضريبة
2. taxRate - نسبة الضريبة (افتراضي 15%)
3. taxAmount - مبلغ الضريبة
4. discountType - نوع الخصم (نسبة/ثابت)
5. discountValue - قيمة الخصم
6. discountAmount - مبلغ الخصم المحسوب

### الإصلاحات المنفذة:
- [x] إضافة 6 أعمدة مفقودة إلى جدول quotations باستخدام SQL مباشر
- [x] تعديل schema.ts لاستخدام totalAmount بدلاً من subtotal (مطابقة قاعدة البيانات)
- [x] إعادة تشغيل السيرفر بعد التعديلات
- [x] اختبار إضافة عرض سعر تجريبي بنجاح

### النتيجة:
✅ تم إصلاح المشكلة بالكامل! الآن يمكن إضافة عروض أسعار مع حسابات الضريبة والخصم بشكل صحيح.

### مثال على عرض سعر تجريبي:
- المبلغ الأصلي: 1,000 ريال
- الضريبة (15%): +150 ريال
- الخصم (10%): -100 ريال
- المبلغ النهائي: 1,050 ريال ✅


## نظام الاعتماد المالي المتكامل (2026-01-15)

### المشكلة الحالية:
- [x] صفحة عروض الأسعار تعرض العروض فقط بدون إمكانية اختيار العرض الفائز
- [x] صفحة الاعتماد المالي فارغة وغير مفعّلة
- [x] لا توجد رحلة واضحة لـ "اختيار العرض → الاعتماد المالي → الانتقال للتنفيذ"

### التصميم المقترح:
- [x] تصميم رحلة الاعتماد المالي الكاملة
- [x] تحديد الصلاحيات لكل دور (مكتب المشاريع، الإدارة المالية، المدير المالي، المدير العام)
- [x] تصميم واجهة صفحة الاعتماد المالي

### Backend Development:
- [ ] إضافة حقل selectedQuotationId في جدول requests
- [ ] إنشاء procedure selectWinningQuotation (اختيار العرض الفائز)
- [ ] إنشاء procedure approveFinancially (الاعتماد المالي النهائي)
- [ ] تحديث procedure updateStage للتحقق من وجود عرض معتمد قبل الانتقال للتنفيذ
- [ ] إضافة صلاحيات المرحلة المالية في STAGE_PERMISSIONS

### Frontend Development:
- [ ] إنشاء صفحة FinancialApproval.tsx الجديدة
- [ ] عرض جدول مقارنة لجميع عروض الأسعار
- [ ] إضافة radio button لاختيار العرض الفائز
- [ ] نموذج الاعتماد المالي (المبلغ المعتمد، المبرر، التوقيع)
- [ ] زر "اعتماد وانتقال للتنفيذ"
- [ ] تطبيق الصلاحيات (إخفاء/إظهار الأزرار حسب الدور)

### الاختبار:
- [ ] اختبار اختيار العرض الفائز
- [ ] اختبار الاعتماد المالي
- [ ] اختبار الانتقال التلقائي للتنفيذ
- [ ] اختبار الصلاحيات لكل دور
- [ ] اختبار الرحلة الكاملة من إضافة العروض حتى الاعتماد


## إصلاح مشكلة الانتقال بعد الاعتماد المالي (2026-01-15)
- [ ] فحص procedure approveFinancially في Backend
- [ ] فحص استدعاء الـ procedure من Frontend
- [ ] التحقق من تحديث currentStage في قاعدة البيانات
- [ ] اختبار الرحلة الكاملة من الاعتماد المالي إلى التعاقد


## إصلاح عدم ظهور زر الاعتماد المالي (2026-01-15)
- [x] فحص كود صفحة FinancialApproval.tsx لمعرفة سبب عدم ظهور الزر
- [x] إصلاح شرط عرض الزر (البحث باستخدام quotationNumber بدلاً من id)
- [x] التأكد من أن الزر يظهر بعد اختيار العرض الفائز
- [x] اختبار الرحلة الكاملة من الواجهة (نجح الانتقال إلى contracting)


## تحسينات نظام الاعتماد المالي (2026-01-15)

### 1. إضافة عمود المبلغ النهائي في جدول عروض الأسعار
- [ ] إضافة عمود "المبلغ النهائي" في جدول عروض الأسعار في صفحة Quotations.tsx
- [ ] إضافة عمود "المبلغ النهائي" في جدول المقارنة في صفحة FinancialApproval.tsx
- [ ] التأكد من عرض المبلغ بعد الضريبة والخصم بشكل صحيح

### 2. إضافة رسالة تأكيد مرئية بعد الاعتماد المالي
- [ ] إضافة Toast/Alert بعد نجاح الاعتماد المالي
- [ ] عرض ملخص العرض المعتمد (المورد، المبلغ، رقم العرض) في الرسالة
- [ ] إضافة تأخير قصير قبل إعادة التوجيه لإعطاء المستخدم فرصة لقراءة الرسالة

### 3. إضافة قسم تفاصيل الاعتماد المالي في صفحة تفاصيل الطلب
- [ ] إنشاء مكون جديد لعرض تفاصيل الاعتماد المالي
- [ ] عرض العرض المعتمد (رقم العرض، المورد، المبلغ النهائي)
- [ ] عرض تاريخ الاعتماد والشخص الذي قام بالاعتماد
- [ ] إضافة المكون إلى صفحة RequestDetails.tsx
- [ ] التأكد من ظهور القسم فقط للطلبات التي تم اعتمادها مالياً

### 4. اختبار جميع التحسينات
- [ ] اختبار عمود المبلغ النهائي في جدول عروض الأسعار
- [ ] اختبار رسالة التأكيد بعد الاعتماد المالي
- [ ] اختبار قسم تفاصيل الاعتماد المالي في صفحة تفاصيل الطلب
- [ ] اختبار الرحلة الكاملة من البداية للنهاية


## تحسينات نظام الاعتماد المالي (2026-01-15)
- [x] إضافة عمود "المبلغ النهائي" في جدول عروض الأسعار (Quotations.tsx)
- [x] إضافة رسالة تأكيد مرئية بعد الاعتماد المالي مع تفاصيل العرض
- [x] إنشاء مكون FinancialApprovalDetails لعرض تفاصيل الاعتماد المالي
- [x] إضافة قسم تفاصيل الاعتماد المالي في صفحة تفاصيل الطلب (RequestDetails.tsx)


## تحسين صفحة إنشاء العقد (2026-01-15)
- [ ] قراءة requestId من URL تلقائياً
- [ ] جلب بيانات الطلب والعرض المعتمد من Backend
- [ ] عرض بطاقة معلومات الطلب في أعلى الصفحة
- [ ] ملء حقول النموذج تلقائياً (المورد، المبلغ، التواريخ)
- [ ] إخفاء الرسالة التحذيرية عند وجود requestId
- [ ] اختبار الرحلة الكاملة من صفحة تفاصيل الطلب


## المرحلة 25: تحسين تجربة المستخدم - مرحلة الزيارة الميدانية

### استبدال رسالة الخطأ ببطاقة إجراء واضحة
- [ ] استبدال رسالة الخطأ "يجب رفع تقرير المعاينة الميدانية" ببطاقة إجراء واضحة
- [ ] إضافة زر "رفع تقرير الزيارة الميدانية" في صفحة تفاصيل الطلب
- [ ] توجيه المستخدم مباشرة إلى نموذج رفع التقرير عند النقر على الزر
- [ ] إخفاء الزر بعد رفع التقرير وإظهار زر المرحلة التالية
- [ ] تطبيق نفس المنطق على جميع المراحل التي تتطلب إجراءات مسبقة


## المرحلة 26: مراجعة وإصلاح كامل رحلة الطلب

### 1. إزالة رسائل الخطأ المكررة
- [ ] إزالة رسالة "لا يمكن الانتقال للمرحلة التالية" عندما يكون هناك زر إجراء نشط
- [ ] التأكد من عدم ظهور رسالتين في نفس الوقت (زر إجراء + رسالة خطأ)

### 2. التأكد من وجود جميع أزرار الإجراءات في كل مرحلة
- [ ] مرحلة تقديم الطلب (submitted) → زر "بدء المراجعة الأولية"
- [ ] مرحلة المراجعة الأولية (initial_review) → زر "جدولة الزيارة الميدانية"
- [ ] مرحلة الزيارة الميدانية (field_visit) → زر "جدولة الزيارة" ثم زر "رفع تقرير الزيارة"
- [ ] مرحلة التقييم الفني (technical_eval) → 4 أزرار (اعتذار، تعليق، استجابة سريعة، تحويل لمشروع)
- [ ] مرحلة التقييم المالي (financial_eval) → زر "اعتماد التقييم المالي"
- [ ] مرحلة التنفيذ (execution) → زر "إنشاء عقد" أو "رفع تقرير استجابة سريعة"
- [ ] مرحلة الإغلاق (closed) → زر "رفع التقرير الختامي"

### 3. إصلاح عرض معلومات المشروع
- [ ] إصلاح عرض "المسجد" في الشريط الجانبي (يظهر "غير محدد")
- [ ] إصلاح عرض "البرنامج" في الشريط الجانبي (يظهر "غير محدد")
- [ ] إصلاح عرض "الموضوع" في الشريط الجانبي (يظهر "غير محدد")
- [ ] إصلاح عرض "التاريخ" في الشريط الجانبي

### 4. اختبار رحلة الطلب الكاملة
- [ ] اختبار من تقديم الطلب حتى الإغلاق (End-to-End)
- [ ] التأكد من ظهور الأزرار الصحيحة في كل مرحلة
- [ ] التأكد من اختفاء الأزرار بعد إتمام الإجراء
- [ ] التأكد من تسجيل جميع الإجراءات في السجل الزمني


## المرحلة 26: مراجعة وإصلاح رحلة الطلب الكاملة
- [x] إزالة رسائل الخطأ المكررة في جميع المراحل
- [x] التأكد من وجود جميع أزرار الإجراءات في كل مرحلة
- [x] إصلاح عرض معلومات المسجد/البرنامج في الشريط الجانبي
- [x] اختبار رحلة الطلب الكاملة


## إصلاح عاجل: رسالة الخطأ المكررة
- [ ] فحص الكود لمعرفة سبب ظهور رسالة "لا يمكن الانتقال للمرحلة التالية" رغم الإصلاحات السابقة
- [ ] إزالة الرسالة بشكل نهائي من جميع الأماكن
- [ ] التأكد من أن الزر الوحيد الظاهر هو زر الإجراء المطلوب (مثل "جدولة الزيارة الميدانية")
- [ ] اختبار الإصلاح من الواجهة


## 🚨 إصلاح شامل عاجل: صفحة تفاصيل الطلب

### 1. إصلاح عرض المعلومات في الشريط الجانبي
- [ ] إصلاح عرض "غير محدد" في المسجد → عرض اسم المسجد أو "برنامج بنيان"
- [ ] إصلاح عرض "غير محدد" في الموضوع → عرض موضوع الطلب الفعلي
- [ ] إصلاح عرض "غير محدد" في البرنامج → عرض اسم البرنامج (صيانة، بنيان، إلخ)
- [ ] إصلاح عرض "غير محدد" في التاريخ → عرض تاريخ التقديم بشكل صحيح

### 2. إصلاح السجل الزمني (Timeline)
- [ ] استبدال "stage_updated" بأسماء واضحة للأحداث
- [ ] إضافة وصف واضح لكل حدث (مثل "تم نقل الطلب إلى مرحلة الزيارة الميدانية")
- [ ] عرض اسم المستخدم الذي قام بالإجراء
- [ ] عرض التاريخ والوقت بشكل واضح

### 3. إضافة بطاقة تقدم (Progress Checklist)
- [ ] تصميم بطاقة تقدم في أعلى الصفحة
- [ ] عرض قائمة مرجعية بالإجراءات المطلوبة في المرحلة الحالية
- [ ] تمييز الإجراءات المكتملة بعلامة ✓
- [ ] تمييز الإجراء الحالي المطلوب
- [ ] إخفاء البطاقة عندما تكون جميع الإجراءات مكتملة

### 4. نظام الصلاحيات والأدوار
- [ ] إضافة جدول user_roles في قاعدة البيانات
- [ ] تعريف الأدوار: مكتب المشاريع، الفريق الميداني، الإدارة المالية، المدير العام
- [ ] إضافة جدول role_permissions لربط الأدوار بالصلاحيات
- [ ] إخفاء/إظهار الأزرار حسب دور المستخدم
- [ ] إضافة رسالة توضيحية عند عدم وجود صلاحية

### 5. نظام الإشعارات التلقائية
- [ ] إضافة جدول notifications في قاعدة البيانات
- [ ] إرسال إشعار عند استيفاء جميع الشروط للانتقال للمرحلة التالية
- [ ] إرسال إشعار عند إسناد مهمة جديدة للمستخدم
- [ ] عرض الإشعارات في header البوابة
- [ ] إضافة صفحة "الإشعارات" لعرض جميع الإشعارات

### 6. اختبار شامل
- [ ] اختبار عرض المعلومات في الشريط الجانبي
- [ ] اختبار السجل الزمني
- [ ] اختبار بطاقة التقدم في جميع المراحل
- [ ] اختبار نظام الصلاحيات لجميع الأدوار
- [ ] اختبار نظام الإشعارات


## المرحلة 24: تحسينات صفحة تفاصيل الطلب
- [x] إضافة بطاقة جدولة الزيارة الميدانية (RequestProgressCard)
- [x] تحسين عرض السجل الزمني لإظهار المراحل بشكل واضح
- [x] إصلاح عرض معلومات المشروع في الشريط الجانبي
- [x] تحسين شريط المراحل (ProgressStepper) ليعرض 10 مراحل
- [ ] إصلاح مشكلة cache المتصفح في عرض السجل الزمني (يتطلب فتح الصفحة من متصفح جديد)


## المرحلة 28: إعادة تصميم نظام المراحل والإجراءات
- [x] إنشاء جدول تكوين المراحل (Stage Configuration) يربط كل مرحلة بالإجراء المناسب
- [x] تحديد العلاقات بين الإجراءات (قبله، بعده، يتزامن معه، غير مرتبط)
- [x] تحديث SmartStatusBar لاستخدام جدول التكوين الجديد
- [x] إصلاح عرض الإجراء الصحيح حسب المرحلة الحالية
- [x] اختبار شامل لجميع المراحل والإجراءات
- [x] حفظ checkpoint


## المرحلة 29: صفحة إعدادات المراحل التفاعلية
- [ ] إنشاء جدول قاعدة البيانات لإعدادات المراحل (stage_settings)
- [ ] إنشاء Backend API لإدارة إعدادات المراحل (CRUD)
- [ ] إعادة بناء صفحة إعدادات المراحل (/stage-settings)
- [ ] إضافة واجهة تعديل ترتيب الإجراءات (Drag & Drop)
- [ ] إضافة واجهة تعديل العلاقات بين الإجراءات (قبله، بعده، يتزامن معه، غير مرتبط)
- [ ] إضافة واجهة تعديل الشروط المسبقة لكل إجراء
- [ ] إضافة واجهة تعديل الصلاحيات المطلوبة لكل إجراء
- [ ] حفظ التغييرات في قاعدة البيانات
- [ ] اختبار شامل للصفحة
- [ ] حفظ checkpoint


## المرحلة 30: ربط SmartStatusBar بقاعدة البيانات
- [ ] تحديث SmartStatusBar لقراءة الإجراءات من action_settings بدلاً من stageActionConfig
- [ ] إضافة query لجلب الإجراءات من قاعدة البيانات
- [ ] تحديث منطق عرض الإجراء النشط
- [ ] اختبار انعكاس التغييرات من صفحة إعدادات الإجراءات على البطاقة
- [ ] حفظ checkpoint


## المرحلة 31: فحص وإصلاح منطق SmartStatusBar
- [ ] إضافة console.log في getActiveAction() لتتبع المنطق
- [ ] إضافة console.log في checkActionCompletion() لتتبع التحقق من الإتمام
- [ ] فحص المنطق وإصلاح أي أخطاء
- [ ] اختبار شامل على طلبات في مراحل مختلفة (submitted, initial_review, field_visit, technical_eval, financial_eval)
- [ ] التأكد من عرض الإجراء الصحيح في كل مرحلة
- [ ] حفظ checkpoint نهائي


## المرحلة 32: تبسيط النظام وربط البطاقة بقاعدة البيانات مباشرة
- [ ] حذف SmartStatusBar واستعادة البطاقة الأصلية في RequestDetails.tsx
- [ ] تحديث البطاقة لجلب الإجراءات من action_settings بدلاً من الكود الثابت
- [ ] إضافة منطق بسيط لتحديد الإجراء النشط حسب المرحلة
- [ ] اختبار على طلب في مرحلة field_visit
- [ ] حفظ checkpoint

## المرحلة 25: ربط صفحة إعدادات الإجراءات بالنظام

### ربط stageActionConfig.ts بقاعدة البيانات
- [ ] تحليل البنية الحالية وتصميم الحل
- [ ] إنشاء دالة قراءة الإجراءات من قاعدة البيانات
- [ ] تحديث SmartStatusBar لاستخدام الدالة الجديدة
- [ ] اختبار شامل للنظام
- [ ] حفظ checkpoint

## تحديث المرحلة 25 (مكتمل)
- [x] تحليل البنية الحالية وتصميم الحل
- [x] إنشاء دالة قراءة الإجراءات من قاعدة البيانات
- [x] تحديث SmartStatusBar لاستخدام الدالة الجديدة (تم إنشاء RequestActionCard)
- [x] اختبار شامل للنظام


## المرحلة 26: إعداد بيئة تجريبية شاملة للبوابة
- [ ] إنشاء script لتعبئة قاعدة البيانات بالبيانات النموذجية
  ...
  - [ ] موردين وعروض أسعار
  - [ ] جداول كميات (BOQ)
- [ ] تنفيذ script وإنشاء البيانات التجريبية
- [ ] اختبار شامل للتكامل بين الأنظمة
  - [ ] اختبار سير العمل الكامل
  - [ ] اختبار الصلاحيات والأدوار
  - [ ] اختبار التكامل بين الطلبات والمشاريع
  - [ ] اختبار التكامل بين العقود وطلبات الصرف
- [ ] تقييم البوابة وتحديد الأمور المتبقية
- [ ] إعداد تقرير شامل وحفظ checkpoint

- [x] إنشاء script لتعبئة قاعدة البيانات بالبيانات النموذجية
- [x] تنفيذ script وإنشاء البيانات التجريبية (5 مستخدمين، 2 مساجد، 2 موردين، 11 طلب)
- [x] اختبار شامل للتكامل بين الأنظمة (الصفحة الرئيسية، لوحة التحكم، الطلبات، المساجد، الموردين، إعدادات الإجراءات)
- [x] تقييم البوابة وتحديد الأمور المتبقية
- [x] إعداد تقرير شامل للتقييم


## المرحلة 27: نظام الأدوار والصلاحيات المتكامل

### المستوى الأول: الصلاحيات الفردية
- [ ] تصميم جدول user_permissions للصلاحيات الفردية
- [ ] بناء API لمنح/سحب صلاحيات فردية
- [ ] بناء واجهة إدارة الصلاحيات الفردية
- [ ] توثيق التغييرات (audit log)

### المستوى الثاني: المسميات المرنة (Roles/Groups)
- [ ] تصميم جدول roles للمسميات المرنة
- [ ] تصميم جدول role_permissions لصلاحيات كل مسمى
- [ ] تصميم جدول user_roles لربط المستخدمين بالمسميات
- [ ] بناء API لإدارة المسميات والصلاحيات
- [ ] بناء واجهة إدارة المسميات

### المستوى الثالث: الهيكل الهرمي
- [ ] تصميم جدول modules للعناوين الرئيسية
- [ ] تصميم جدول permissions للصلاحيات التفصيلية
- [ ] بناء API لإدارة الهيكل الهرمي
- [ ] بناء واجهة عرض الهيكل الهرمي

### التكامل والتطبيق
- [ ] بناء دالة حساب الصلاحيات النهائية (merge permissions)
- [ ] بناء middleware للتحقق من الصلاحيات
- [ ] تطبيق النظام على جميع الصفحات
- [ ] تطبيق النظام على أزرار الإجراءات
- [ ] اختبار شامل للصلاحيات

## تحديث: نظام الأدوار والصلاحيات (تقدم)

### المكتمل:
- [x] تصميم Schema للنظام (وثيقة 12 صفحة)
- [x] إنشاء 7 جداول قاعدة بيانات
- [x] تهيئة 70 صلاحية + 9 أدوار افتراضية
- [x] بناء Backend API (20 endpoint)

### المتبقي:
- [ ] بناء واجهة إدارة الأدوار
- [ ] بناء واجهة إدارة صلاحيات المستخدمين
- [ ] بناء واجهة الهيكل الهرمي
- [ ] تطبيق النظام على الصفحات الموجودة
- [ ] اختبار شامل

## المرحلة 28: إكمال نظام الأدوار والصلاحيات (Frontend + التطبيق)

### المرحلة 1: Hooks والدوال المساعدة
- [ ] إنشاء usePermission hook
- [ ] إنشاء usePermissions hook
- [ ] إنشاء PermissionGuard component

### المرحلة 2: واجهة إدارة الأدوار
- [ ] صفحة قائمة الأدوار
- [ ] صفحة إنشاء/تعديل دور
- [ ] واجهة تحديد الصلاحيات (checkboxes منظمة)
- [ ] اختبار إنشاء دور جديد
- [ ] اختبار تعديل صلاحيات دور

### المرحلة 3: واجهة إدارة صلاحيات المستخدمين
- [ ] صفحة إدارة صلاحيات مستخدم
- [ ] قسم الأدوار المسندة
- [ ] قسم الصلاحيات الفردية
- [ ] عرض الصلاحيات النهائية
- [ ] اختبار إسناد أدوار
- [ ] اختبار منح/سحب صلاحيات فردية

### المرحلة 4: تطبيق النظام
- [ ] تطبيق على صفحة الطلبات
- [ ] تطبيق على صفحة المساجد
- [ ] تطبيق على صفحة المشاريع
- [ ] تطبيق على صفحة العقود
- [ ] تطبيق على صفحة الموردين
- [ ] تطبيق على لوحة التحكم
- [ ] تطبيق على الشريط الجانبي

### المرحلة 5: اختبار وحل المشكلات
- [ ] اختبار شامل لجميع الصلاحيات
- [ ] اختبار الصلاحيات الفردية
- [ ] اختبار الأدوار المتعددة
- [ ] اختبار التعارضات
- [ ] حل جميع المشكلات

## تحديث: نظام الأدوار والصلاحيات (Frontend)

### المكتمل:
- [x] إنشاء usePermission hooks (4 hooks)
- [x] إنشاء PermissionGuard component
- [x] صفحة قائمة الأدوار
- [x] صفحة إنشاء/تعديل دور
- [x] إضافة المسارات في App.tsx
- [x] حل مشكلة التعارض في schema.ts
...
## المرحلة 28: إكمال نظام الأدوار والصلاحيات

### المهام:
- [ ] بناء صفحة إدارة صلاحيات المستخدمين
- [ ] تطبيق PermissionGuard على الصفحات الرئيسية
- [ ] إنشاء مستخدمين تجريبيين بأدوار مختلفة
- [ ] اختبار شامل للصلاحيات
- [ ] حفظ checkpoint نهائي

## تحديث المرحلة 28:
- [x] بناء صفحة إدارة صلاحيات المستخدمين
- [ ] تطبيق PermissionGuard على الصفحات الرئيسية
- [ ] إنشاء مستخدمين تجريبيين بأدوار مختلفة
- [ ] اختبار شامل للصلاحيات

## المرحلة 29: إكمال نظام الصلاحيات وإدارة المستخدمين

### المهام:
- [ ] تطبيق PermissionGuard على صفحات الطلبات والمساجد والموردين
- [ ] حذف المستخدمين الحاليين (عدا المدير وعبدالإله المرزوقي)
- [ ] إنشاء مستخدمين تجريبيين بأدوار مختلفة (مدير، مكتب مشاريع، فريق ميداني)
- [ ] بناء صفحة إدارة المستخدمين الشاملة
- [ ] اختبار شامل للصلاحيات
- [ ] حفظ checkpoint نهائي

- [x] تطبيق PermissionGuard على صفحات الطلبات والمساجد والموردين
- [x] حذف/تعطيل المستخدمين الحاليين (عدا المدير وعبدالإله المرزوقي)
- [x] إنشاء مستخدمين تجريبيين بأدوار مختلفة (مدير، مكتب مشاريع، فريق ميداني)

## المرحلة 28: إكمال نظام الأدوار والصلاحيات بشكل نموذجي
- [ ] مراجعة مراحل الطلبات (10 مراحل) وربطها بالصلاحيات
- [ ] تحديد الصلاحيات المطلوبة لكل مرحلة ولكل دور
- [ ] بناء صفحة إدارة المستخدمين الشاملة مع تبويبين (موظفين وطالبي خدمة)
- [ ] إضافة إمكانية الوصول السريع لإدارة صلاحيات المستخدمين
- [ ] إضافة إمكانية تفعيل/تعطيل حسابات المستخدمين
- [ ] إسناد الأدوار المناسبة للمستخدمين التجريبيين
- [ ] اختبار شامل للصلاحيات مع جميع الأدوار
- [ ] توثيق النظام بالكامل

## تحديث: المرحلة 28
- [x] مراجعة مراحل الطلبات (10 مراحل) وربطها بالصلاحيات
- [x] تحديد الصلاحيات المطلوبة لكل مرحلة ولكل دور
- [x] بناء صفحة إدارة المستخدمين الشاملة مع تبويبين (موظفين وطالبي خدمة)
- [x] إضافة إمكانية الوصول السريع لإدارة صلاحيات المستخدمين
- [x] إضافة إمكانية تفعيل/تعطيل حسابات المستخدمين
- [ ] إسناد الأدوار المناسبة للمستخدمين التجريبيين
- [ ] اختبار شامل للصلاحيات مع جميع الأدوار
- [ ] توثيق النظام بالكامل

## المرحلة 29: إكمال نظام الصلاحيات
- [ ] إسناد الأدوار للمستخدمين التجريبيين عبر الواجهة
- [ ] اختبار ظهور/إخفاء الأزرار بعد إسناد الأدوار
- [ ] تطبيق PermissionGuard على أزرار التعديل في جميع الصفحات
- [ ] تطبيق PermissionGuard على أزرار الحذف في جميع الصفحات
- [ ] تطبيق PermissionGuard على أزرار الاعتماد في جميع الصفحات
- [ ] بناء صفحة سجل التدقيق
- [ ] اختبار شامل للصلاحيات مع جميع الأدوار
- [ ] توثيق النظام

- [x] إسناد الأدوار للمستخدمين التجريبيين


## المرحلة 28: إكمال نظام الصلاحيات والتحقق من سير الطلبات
- [ ] تعديل أسماء المستخدمين التجريبيين (محمد المصعدي، تركي الشريف، سلمان العلياني)
- [ ] حذف مستخدم "محمد سعيد - طالب خدمة"
- [ ] إضافة حقل "المسؤول الحالي" في صفحة الطلبات
- [ ] إضافة إمكانية إعادة الطلب للمستفيد
- [ ] التحقق من سير الطلب في جميع المراحل بدون أخطاء
- [ ] تطبيق PermissionGuard على أزرار التعديل والحذف في صفحة المساجد
- [ ] تطبيق PermissionGuard على أزرار التعديل والحذف في صفحة الموردين
- [ ] تطبيق PermissionGuard على أزرار الإجراءات في صفحة تفاصيل الطلب
- [ ] بناء صفحة سجل التدقيق
- [ ] اختبار شامل للصلاحيات مع المستخدمين التجريبيين

## المرحلة 47: تحديثات إضافية على النظام
- [x] تعديل أسماء المستخدمين التجريبيين (محمد المصعدي، تركي الشريف، سلمان العلياني)
- [x] إضافة حقل المسؤول الحالي للطلبات (currentResponsible و currentResponsibleDepartment)
- [x] تحديث تلقائي للمسؤول الحالي عند تغيير المرحلة
- [x] إكمال تطبيق PermissionGuard على أزرار التعديل والحذف والاعتماد في جميع الصفحات
- [x] بناء صفحة سجل التدقيق (permissions_audit_log) مع فلترة حسب المستخدم والتاريخ ونوع الإجراء

## المرحلة 48: إصلاح حساب المدير
- [x] إعادة إنشاء حساب المدير (admin@tamam.sa) بكلمة المرور Admin@123456

## المرحلة 49: تحديثات نظام المستخدمين
- [x] تعديل أسماء المستخدمين التجريبيين (محمد المصعدي، تركي الشريف، سلمان العلياني)
- [x] تفعيل حسابات المستخدمين التجريبيين (تغيير الحالة من موقوف إلى نشط)
- [x] إخفاء خيار التسجيل من الصفحة الرئيسية (اقتصار على الحساب الرئيسي)
- [x] إصلاح أزرار التعديل والحذف في صفحة المستخدمين
- [x] إضافة زر "تنشيط" بجانب زر "إيقاف"
- [x] جعل الدخول لصفحة المستخدم بالضغط على الاسم مباشرة
- [x] إضافة أزرار التعديل/الحذف/الصلاحيات في صفحة تفاصيل المستخدم
