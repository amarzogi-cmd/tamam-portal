...
## المرحلة 25: إصلاح شامل لنظام الإجراءات في صفحة تفاصيل الطلب
- [ ] تحليل المشكلة الحالية: بطاقة "جدولة الزيارة" تظهر رغم أن الطلب في مرحلة الزيارة الميدانية
- [ ] إنشاء تبويب "الإجراءات" الجديد يحتوي على جميع أزرار الإجراءات المتاحة
- [ ] إعادة ترتيب التبويبات: معلومات المشروع، الإجراءات، السجل الزمني، المرفقات، التعليقات
- [ ] جعل شريط المراحل تفاعلي - يمكن الضغط على المرحلة التالية مباشرة
- [ ] إصلاح منطق عرض الإجراءات حسب المرحلة الحالية
- [ ] إضافة جميع أزرار الإجراءات: جدولة الزيارة، تقديم التقرير، التقييم الفني، الاعتماد المالي، إلخ
- [ ] تطبيق قاعدة: زر الإجراء يكون نشطًا فقط لمن يملك الصلاحية
- [ ] اختبار النظام الجديد مع جميع المراحل
- [ ] حفظ checkpoint نهائي


## المرحلة 26: إعادة تصميم نظام الإجراءات وإضافة تبويب الإجراءات
- [x] إنشاء مكون RequestActionsPanel الجديد
- [x] إضافة تبويب "الإجراءات" في صفحة تفاصيل الطلب
- [x] إصلاح منطق عرض الأزرار حسب المرحلة الحالية
- [x] حذف SmartStatusBar من RequestDetails
- [x] حذف RequestProgressCard من RequestDetails
- [x] إزالة قسم الإجراءات من الشريط الجانبي
- [x] تنظيف imports غير المستخدمة
- [x] حذف cache Vite وإعادة build

## ملاحظات مهمة:
- قد يتطلب عرض التحديثات فتح الصفحة من متصفح جديد أو وضع التصفح الخفي بسبب cache المتصفح
- جميع التعديلات في الكود صحيحة ومكتملة
- النظام الجديد يعرض الإجراءات بشكل منظم في تبويب مستقل
